<?php session_start();
if($_SESSION['perfil'] != 3) {header("location: index.php");}
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<main>
<h1 id="conteudo">Check-list de embarcações</h1>
<p>Gerencie as entradas e saídas das embarcações</p>
